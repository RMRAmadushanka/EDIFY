...
import { AdminOrderManagement, UserOrderManagement } from '../features/order/components';
...
const routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        element:(         <Sidebar><PrivateRoleRoute component={AdminDashboard} roles={['super-admin']}/></Sidebar>),
      },
      {
        path: '',
        element:(         <Sidebar><PrivateRoleRoute component={UserDashboard} roles={['user']}/></Sidebar>),
      },
      {
        path: ROUTES.PRODUCT_MANAGEMENT,
        element:(         <Sidebar><PrivateRoleRoute component={ProductTable} roles={['super-admin']}/></Sidebar>),
      },
      {
        path: ROUTES.ADD_PRODUCT,
        element:(         <Sidebar><PrivateRoleRoute component={AddProduct} roles={['super-admin']}/></Sidebar>),
      },
      {
        path: ROUTES.CATEGORY_MANAGEMENT,
        element:(         <Sidebar><PrivateRoleRoute component={CategoryManagement} roles={['super-admin']}/></Sidebar>),
      },
      {
        path: ROUTES.ORDER_MANAGEMENT_ADMIN,
        element:(         <Sidebar><PrivateRoleRoute component={AdminOrderManagement} roles={['super-admin']}/></Sidebar>),
      },
      {
        path: ROUTES.ORDER_MANAGEMENT_USER,
        element:(         <Sidebar><PrivateRoleRoute component={UserOrderManagement} roles={['user']}/></Sidebar>),
      },
